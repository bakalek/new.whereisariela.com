...
function optionsframework_options() {
	...
	$options[] = array( "name" => __("Homepage", 'organicthemes'),
		...
		$options[] = array( "name" => __("Featured Page", 'organicthemes'),
							"desc" => __("Choose the page you wish to display on the homepage.", 'organicthemes'),
							"id" => "featured_page",
		...
		$options[] = array( "name" => __("Featured Posts Displayed", 'organicthemes'),
							"desc" => __("Enter the number of posts you would like to display in the featured posts section.", 'organicthemes'),
							"id" => "postnumber_news",
							"std" => "3",
							"type" => "text");
							
		$options[] = array( "name" => __("Display Featured Page?", 'organicthemes'),
							"desc" => __("Selecting this option will display the featured page at the top of the homepage.", 'organicthemes'),
							"id" => "display_home_page",
							"std" => "1",
							"type" => "checkbox");
							
		$options[] = array( "name" => __("Display Featured Posts?", 'organicthemes'),
							"desc" => __("Selecting this option will display the featured posts at the bottom section of the homepage.", 'organicthemes'),
							"id" => "display_home_posts",
							"std" => "1",
							"type" => "checkbox");
	...
	$options[] = array( "name" => __("Colors", 'organicthemes'),
		...
		$options[] = array( "name" => __("Navigation Color", 'organicthemes'),
							"desc" => __("Select the color you wish to use for the site navigation background.", 'organicthemes'),
							"id" => "nav_color",
							"std" => "#FFFFFF",
							"type" => "color");
